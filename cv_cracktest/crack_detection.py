...
c_trans = cmeas.translate(
    crack_rot, (cx, cy), (img.shape[0]/2, img.shape[0]/2-200))
blank3 = np.zeros(img.shape[:2], np.uint8)
cv.drawContours(blank3, [c_trans], 0, 250, -1)
cv.imshow("Crack1 - translated", blank3)
